...
use aionui_api_types::{
    ...
    SnapshotDiscardRequest, SnapshotInfoResponse, SnapshotStageRequest,
...
use crate::types::{
    CompareResult, CopyResult, DirOrFile, FileChangeInfo, FileMetadata, SnapshotInfo,
